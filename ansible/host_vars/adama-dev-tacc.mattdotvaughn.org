...
ansible_ssh_host: 129.114.6.164
...
config:
  ...
  -
    option: url
    section: server
    value: http://adama-dev-tacc.mattdotvaughn.org
  -
    option: bind
    section: server
    value: "0.0.0.0:80"
  ...
  -
    option: swagger_ui
    section: server
    value: http://adama-dev-tacc.mattdotvaughn.org/swagger-ui
  -
...
monitor:
  ...
  -
    option: url
    section: api
    value: http://adama-dev-tacc.mattdotvaughn.org/community/v0.3
  -
    option: token
    section: api
...
nginx_server_name: adama-dev-tacc.mattdotvaughn.org
self_sign: true
